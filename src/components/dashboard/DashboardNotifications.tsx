...
export function DashboardNotifications({ userType }: DashboardNotificationsProps) {
  // Sample notifications - in a real app, this would come from your API
  const notifications = userType === "buyer"
    ? [] // Empty for employer
    : [
        {
          id: 1,
          icon: FileText,
          message: "The application is undo approved on your job Abdul Narrator by Employer.",
          time: "7 months ago",
        ...
        },
        {
          id: 2,
          icon: FileText,
          message: "A new meeting is created on the job Abdul Narrator by Employer.",
          time: "8 months ago",
          color: "text-green-600",
        },
        {
          id: 3,
          icon: FileText,
          message: "The application is approved on your job Abdul Narrator by Employer.",
          time: "8 months ago",
          color: "text-green-600",
        },
      ];
