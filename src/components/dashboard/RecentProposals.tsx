...
export function RecentProposals({ userType }: RecentProposalsProps) {
  ...
  const proposals = userType === "buyer"
  ...
  return (
    <Card className="bg-white">
      <CardHeader>
        <CardTitle className="text-xl font-bold text-gray-900">Recent Service Orders</CardTitle>
      </CardHeader>
      <CardContent>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200">
                ...
                <th className="text-left py-3 px-4 text-sm font-semibold text-gray-700">Cost/Time</th>
