...
export const AdBlock = ({
  ...
  return (
    <div className="relative w-full lg:w-[180px] h-[200px] sm:h-[250px] overflow-hidden group cursor-pointer shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-[1.02]">
