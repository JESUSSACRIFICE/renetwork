      ...
      <div className="container py-8 md:py-16 relative">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight animate-fade-in">
                Find the Right{" "}
                <span className="bg-gradient-to-r from-primary to-primary-dark bg-clip-text text-transparent">Real Estate Pro</span>
              </h1>
              <p className="text-lg md:text-xl text-muted-foreground max-w-xl">
                Connect with verified real estate professionals, mortgage consultants, and trade experts. 
                Referral-based networking with secure payment protection.
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3 animate-fade-in">
              ...
              {popularSearches.map((search, index) => (
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  onClick={() => router.push(`/browse?category=${search.category}`)}
            ...
            <div className="flex flex-wrap items-center gap-8 pt-6 animate-fade-in">
              <div className="text-center group cursor-pointer">
                <div className="text-4xl font-bold bg-gradient-to-r from-primary to-primary-dark bg-clip-text text-transparent group-hover:scale-110 transition-transform">5,000+</div>
              ...
              <div className="text-center group cursor-pointer">
                <div className="text-4xl font-bold bg-gradient-to-r from-primary to-primary-dark bg-clip-text text-transparent group-hover:scale-110 transition-transform">25,000+</div>
                <div className="text-sm text-muted-foreground font-medium mt-1">
              ...
              <div className="h-12 w-px bg-border" />
              <div className="text-center group cursor-pointer">
                <div className="text-4xl font-bold bg-gradient-to-r from-primary to-primary-dark bg-clip-text text-transparent group-hover:scale-110 transition-transform">98%</div>
                <div className="text-sm text-muted-foreground font-medium mt-1">
                  Satisfaction Rate
                </div>
              </div>
          ...
          <div className="relative animate-fade-in hidden lg:block">
            <div className="absolute -top-10 -right-10 w-96 h-96 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-3xl blur-2xl animate-pulse" style={{ animationDelay: "0.5s" }} />
            <Image
              src={heroImage}
            ...
            <div className="absolute -bottom-6 -left-6 bg-card p-4 rounded-2xl shadow-xl border-2 border-primary/10 backdrop-blur-sm animate-float">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-bold text-success">Verified Professional</div>
